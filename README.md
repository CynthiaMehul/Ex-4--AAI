...
observed_sequence = np.array([1, 0, 1, 1])
...
for t in range(1, len(observed_sequence)):
    for j in range(len(initial_probabilities)):
        alpha[t, j] = emission_matrix[j, observed_sequence[t]] * np.sum(
            alpha[t - 1, :] * transition_matrix[:, j]
        )
...
<img width="467" height="55" alt="image" src="https://github.com/user-attachments/assets/fd74dcfd-81b3-4f58-bdab-401b8b54ac29" />
